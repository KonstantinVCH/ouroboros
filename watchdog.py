...
# Используем домашнюю директорию — работает одинаково в bash/MINGW64 и Windows Python
LOG_FILE = pathlib.Path.home() / ".ouroboros" / "Ouroboros" / "logs" / "bot.log"
WATCHDOG_LOG_FILE = pathlib.Path.home() / ".ouroboros" / "Ouroboros" / "logs" / "watchdog.log"
